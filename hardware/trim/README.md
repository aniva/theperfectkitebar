...
| **8mm (Legacy)** | 2.0mm | **Variant 3** | Legacy compatibility part for thick 8mm depower lines on standard off-the-shelf bars. *Not used in standard TPKB.* | [STEP](sheeting_rope_8mm/front_line_2mm/v-splitter/variant_3/v-splitter_8x2_mjf.step) \| [STL](sheeting_rope_8mm/front_line_2mm/v-splitter/variant_3/v-splitter_8x2_mjf.stl) | <img src="sheeting_rope_8mm/front_line_2mm/v-splitter/variant_3/v-splitter_8x2_mjf.png" width="80px"> |
...
| `v-splitter_8x2_mjf.shapr` | `4acd2d9fdaf139598083e8bd3fb39aa2` | 2026-09-05 21:31:12 | [Download](https://storage.googleapis.com/theperfectkitebar-cad-assets/trim/sheeting_rope_8mm/front_line_2mm/v-splitter/variant_3/v-splitter_8x2_mjf.shapr) |
<!-- END_SHAPR_TABLE -->
