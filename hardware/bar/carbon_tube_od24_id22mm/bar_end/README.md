# Bar Ends for 24mm Carbon Tube (OD 24mm / ID 22mm)

This directory contains the design files and specifications for the **Bar Ends** designed to fit a **24mm outer diameter / 22mm inner diameter** carbon tube.
...
This track uses a **3mm channel** designed for **3mm leader lines**.
...
|---------|-------------|---------------|
| **Variant 5** | Traditional sweep-back angle with optimized weight saving and standard leader line channel routing. Fits the standard bar-end knob. | <img src="leader_line_3mm/variant_5/bar-end_24-22_sls.png" width="30%"> |
| **Variant 7** | Refined geometry featuring an updated sweep profile, smoother line entry contours, and a more robust connection socket to prevent stress-fractures under high steering forces. | <img src="leader_line_3mm/variant_7/bar-end_24-22_sls.png" width="30%"> |

Both variants require matching **Bar End Knobs** (`bar-end-knob_24-22_sls.stl`) to plug the outer opening and secure the internal knots.

---

## Specifications

- **Compatibility**: Carbon Tube with OD = 24mm, ID = 22mm
- **Leader Line Size**: 3mm
...
- **Files**:
  - Variant 5 files: [`leader_line_3mm/variant_5`](leader_line_3mm/variant_5)
  - Variant 7 files: [`leader_line_3mm/variant_7`](leader_line_3mm/variant_7)
